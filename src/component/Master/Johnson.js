...
export function Johnson() {
 ...
 <div>
   ...
   <table>
 <tr>
     <td><Link to="/ListOfMedicalJohnson">List of prior Sergeries</Link></td>
     <td><Link to="/ListOfMedicalJohnson">List of Medical Diagnosis</Link></td>
     <td><Link to="/ListOfMedicalJohnson">List of Medication</Link></td>
     <td><Link to="/ListOfMedicalJohnson">Airway Evaluation</Link></td>
     <td><Link to="/ListOfMedicalJohnson">Anesthisiya clearance and Recomandation</Link></td>
     <td><Link to="/ListOfMedicalJohnson">Dr Cristina Hardey</Link></td>
